...
Testing relationship between extinction, population size, and allele richness
With a new population structure:
95% seeds
5% plants
Of plants:
90% seedlings
...
this script 4000 plants per pop (same as V9 except V9 2000 here)
...
maxgen <- 10000         # the total number of generations to simulate

#Moderately important - double check
locusnum <- 12         # the number of different loci currently implemented for the simulation
maxlandsize <- 1e+07   # the maximum number of individuals that can exist in the simulation 
...
```{r}
#Local Survival
localS <- matrix(c( 0.0526315789473675,             0,     0,   0,
                    0.0473684210526316,             0,     0,   0,
                                     0, 0.01111111111,     0,   0,
                                     0,        0.0925, 0.675,   0) , byrow = TRUE, nrow = 4)
#Local Reproduction
localR <- matrix(c(  0,  0,  0, 200,
                     0,  0,  0,   0,
                     0,  0,  0,   0,
...
save(replist, file =
"Q:/Research/All_Projects_by_Species/Phacelia SPECIES/Phacelia_formosula/Phacelia formosula_abiotic/Modelling/Rmetasim/replist_2_8_17_V10_95seed_20rep_10000gen_4000_plants.Rdata")
