---
title: "Building MetaPopGen scripts for Phacelia: building up analyses with popgen calculations"
...
build up plotting and population genetics tools in data analysis phase (working off saved simulation)
...
full details in script and saved parameter file.
...
- write generic code for making print tables (e.g. tabs, padding, like python format) - some of this in Rmetasim code already
...
**************************************************************************************
Even when not running, run this first section to population parameter values (unchanged from V8)
...
```
**************************************************************************************
Not this time - don't need a new dataset. see below for loading results instead.
...
```{r}
#map genotypes (ordered integers) to explicit pairs of alleles, the same way the program does
allele_options <- 1:l
...
#Creates 'genotypes', a vector with m genotypes made up of l alleles ordered the way the program maps allele pairs to genotype integers. 
...
**************************************************************************************
Picking up work for 3/15/17: plot pairwise Fst over time, using loaded data from last week's calculations (above work - not run again)
...
Build a multilocus object from output of MetaPopGen with replicates.  ***IN PROGRESS*** doesn't work yet.
